...
entry:
  %arridx = alloca [10 x float], align 4
  %arrin = alloca [10 x float], align 4
  %arrout = alloca [10 x float], align 4
  %dt_parm.18 = alloca %struct.__st_parameter_dt, align 8
  %parm.21 = alloca %"struct.array1_real(kind=4).2", align 8
  %parm.20 = alloca %"struct.array1_real(kind=4).3", align 8
  %parm.19 = alloca %"struct.array1_real(kind=4).4", align 8
  %dt_parm.22 = alloca %struct.__st_parameter_dt, align 8
  %dt_parm.23 = alloca %struct.__st_parameter_dt, align 8
  %parm.24 = alloca %"struct.array1_real(kind=4).5", align 8
  br label %entry.split
