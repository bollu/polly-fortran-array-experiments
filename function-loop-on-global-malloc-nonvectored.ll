...
"15":                                             ; preds = %"8"
  tail call void bitcast (void (i8*, ...)* @_gfortran_runtime_error to void (i8*)*)(i8* getelementptr inbounds ([67 x i8], [67 x i8]* @.cst, i64 0, i64 0)) #2
  unreachable
...
"20":                                             ; preds = %"16"
  tail call void bitcast (void (i8*, i8*, ...)* @_gfortran_runtime_error_at to void (i8*, i8*, i8*)*)(i8* getelementptr inbounds ([93 x i8], [93 x i8]* @.cst2, i64 0, i64 0), i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.cst3, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.cst4, i64 0, i64 0)) #2
  unreachable
