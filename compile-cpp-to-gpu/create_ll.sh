...
clang -c -S -emit-llvm -O3 -mllvm -disable-llvm-optzns $1 -o ${LLFILE} -I/users/siddhart/llvm-install/lib/clang/5.0.0/include/ -I/opt/nvidia/cudatoolkit8.0/default/include/
